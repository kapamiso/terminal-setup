# Generated by Powerlevel10k configuration wizard on 2026-03-10 at 20:39 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND='#6087AD'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND='#C8A8FB'
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{DEFAULT,SUDO}_CONTENT_EXPANSION='%n'
